...
euSales = salesClean.map(lambda x:x.split(",")).map(lambda x:(x[3],[x[7],x[6],x[8],x[9]]))

print("jaar, omzet EU, omzet NA, omzet JP, omzet overig")
for jaar, omzet in euSales.take(25):
    print("{}, {}, {}, {}".format(jaar, omzet[0], omzet[1], omzet[2], omzet[3]))